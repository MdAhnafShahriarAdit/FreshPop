...
<div class="footer">
 ...
 <ul>
      ...
      <li ><a href="Facts.php">About US</a></li>      
       <li ><a href="login.php">Contact Us</a></li>
        <li ><a href="registration.php">Ratings</a></li>
        <li ><a href="send_req.php">Be a pro member !</a></li>
        
        <li ><a href="search.php">Sign Up/Sign In </a></li>
        <li ><a href="contact_us.php">Logout</a></li>
...
<div class="copy">
      <p class="title"><br><br>©CSE482 Group 3</p>
    </div>
  <div class="clear"></div>
</div>
</div>
